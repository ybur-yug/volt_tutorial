Volt.configure do |config|
  ...
  #######################################
  config.domain = 'baller-app.com'
  config.app_name = 'Baller_app'
  config.mailer.from = 'Baller_app <no-reply@baller-app.com>'
  ...
  #
  config.app_secret = '8w4FDQ-g6IGs3Eh1MKYR_8oHR-ndVGh1x-kk_W4R6gzkay5QwK6PVVD-zK5vaRi-9CY'
